...
<body>
    ...
    <div class="div3">
        ...
        <h2>Visitor's Details:</h2>
            ...
            <script>
                function displayFormData() {
                    ...
                    displayDiv.innerHTML = '<p>Phone Number: ' + id + '</p><p>Purpose of the vist: ' + Purpose + '</p><p>Vehicle No(ifAny): ' + VehicleNo_ifAny + '</p><p>Date and Time: ' + dt + '</p><p>Checked In By: ' + Inby + '</p>';
                }
            </script>
        </div>
    </div>
        <?php
            ...
            $outdt = 0;
            $inby = mysqli_real_escape_string($connection, $_POST['Inby']);
            $outby = 0;
            if ($id !== null) {
